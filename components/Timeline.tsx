...
const Timeline: React.FC<TimelineProps> = ({ 
  ...
  return (
    <div className="relative w-full h-full bg-[#0F0F10] border-l border-white/5 shadow-2xl flex flex-col overflow-hidden text-slate-200">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto px-8 py-10 no-scrollbar relative">
        <div className="flex items-center justify-between mb-10">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-500 text-[9px] font-black uppercase tracking-[0.2em] hover:bg-amber-600 hover:text-white transition-all active:scale-95"
          >
            標記里程碑
          </button>
        </div>
